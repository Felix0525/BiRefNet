...
class Config():
    def __init__(self) -> None:
        ...
        self.train_size_buckets = [(1856, 1312), (928, 1312)] if self.task == 'HandWrite' else None
        ...
        if self.task in ['Matting']:
            ...
            self.lambdas_pix_last = {
                ...
                'iou': 0.5 * (2 if self.task in ['HandWrite', 'Bin'] else 1),
                'iou_patch': 0.5 * 0,
                'mae': 100 * 1,
                'mse': 30 * 0,
                'triplet': 3 * 0,
        ...
        model_name_to_weights_file = {
            ...
            'swin_v1_t': '/data/models/BiRefNet/swin_tiny_patch4_window7_224_22kto1k_finetune.pth', 'swin_v1_s': 'swin_small_patch4_window7_224_22kto1k_finetune.pth',
